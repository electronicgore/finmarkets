...
\begin{frame}{Fragmented Kyle model: depth}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \structure{Fragmented market is deeper in aggregate} (that's why the speculator is more aggressive)
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Fragmented Kyle model: price discovery}
	\begin{itemize}
		\item \textbf{Price discovery}. We used the fact that everything is normal and $\mathbb{E}[q]=0$ to obtain (see slides on Kyle)
		$$
