...
\begin{frame}{Glosten model: equilibrium}
	\begin{itemize}
		\item If both markets active ($q^I>0$ and $q^E>0$) then (6.7) holds for both
...
\begin{frame}{Glosten model: comparing depth}
	...
	\begin{itemize}
		\item  The pricing equation (6.7) also holds with single platform. This implies $\mathbb{P}(x_I \geq q^I) = \mathbb{P}(x \geq q^C)$ 
