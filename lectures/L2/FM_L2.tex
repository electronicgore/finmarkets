...
\begin{enumerate}
	...
	\item \textbf{Implementation measures}: volume-weighted average price, price impact, implementation shortfall
	...
	\item \textit{Missing data estimators}: Lee-Ready algorithm for trade direction, Roll's measure for quotes
\end{enumerate}
...
\begin{frame}{Comparing the spreads}
	\begin{itemize}
		...
		\item The \structure{realized spread} is more relevant to a market maker (liquidity provider) or a researcher:
		\begin{itemize}
