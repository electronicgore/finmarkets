...
\begin{frame}{Including inventory costs (2)}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item \textbf{\cite{bogousslavsky_should_2020}}: closing auctions account for $7.3\%$ of daily trading volume, but contribute nothing to price discovery. Closing prices deviate a lot from midquotes, but revert back quickly. Why? \visible<handout:0>{\pause\structure{Probably because traders rush to close their positions before EoD.} \pause But also in part because closing auctions are more closed and are of lower quality, see \textbf{\cite{hu_vestigial_2020}}.}
			\end{itemize}
