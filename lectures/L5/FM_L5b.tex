...
\begin{frame}{Today}
	...
	\begin{itemize}
		...
		%	\item Look at estimating the amount of adverse selection in the market (proportion of informed trading)
		%\end{itemize}
...
\begin{frame}{How to estimate?}
	\begin{itemize}
		\item Consider a market with \structure{adverse selection} and \structure{order costs}.
...
\begin{frame}{Issues}
	\begin{itemize}
		...
		\end{itemize}
		\item ...there is the issue of ignoring \structure{inventory costs}.
...
\begin{frame}[label=extending]{Including inventory costs}
	\begin{itemize}
		...
		\end{equation}
		\item Then (5.14) becomes \hyperlink{derivation}{\beamerbutton{Derivation}}
