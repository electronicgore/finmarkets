...
\begin{frame}{Glosten-Milgrom model: Inventory risk edition}
	\begin{itemize}
		...
		\item \structure{Dealer} has some \alert{inventory} $z_t$ of the stock and $c_t$ of cash
...
\begin{frame}{GM-IRE: Quotes}
	To derive equilibrium \alert{quotes}, use the \structure{zero-profit condition}
	\begin{itemize}
