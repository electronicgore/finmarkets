...
\begin{columns}
	\begin{column}{0.6\linewidth}
		...
		\begin{itemize}
			\item \structure{Wednesdays 13.00-15.00} (weeks 6-13,15-20); %
			\item \structure{Fridays 10.00-12.00} (weeks 6,8,10,12,16,18,20).
...
\begin{columns}
	\begin{column}{0.7\linewidth}
		...
		\begin{itemize}
			...
			\item \structure{Study groups} may be helpful. Email me before 17:00 Thu, Feb 09 if you are looking for a group.
		\end{itemize}
		}
	\end{column}
