...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Difference to standard market theory: assume that agents are strategic ($\rightarrow$ game theory)  \hyperlink{strategy}{\beamerbutton{strategy}}
		%TODO: remove "strategy" link and content?
	\end{itemize}
...
%TODO: move purposes to earlier discussion of finmarket; cut the rest of this slide
