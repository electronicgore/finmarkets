...
\begin{columns}
	\begin{column}{0.6\linewidth}
		...
		\begin{itemize}
			\item \structure{Wednesdays 13.00-15.00} (every week 6--20, except week 7 and week 16); %
			\item \structure{Fridays 10.00-12.00} (odd weeks 9--19).
...
\begin{columns}
	\begin{column}{0.7\linewidth}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item \structure{2020 lectures} are \href{https://www.youtube.com/playlist?list=PL4pUs4P_j1Wa2_P1lw44kFWWjKDTGUY7S}{\uline{on youtube}} (not recommended).
			
			\item \structure{Study groups} may be helpful. Email me before 17:00 Thu, Feb 06 if you are looking for a group.
		\end{itemize}
		}
	\end{column}
...
\begin{columns}
	\begin{column}{0.6\linewidth}
		\begin{itemize}
			...
			\begin{itemize}
				\item Common-value setting with dispersed/private information
				\item Because of info asymmetries, usually organized in a specific way and heavily regulated.
			\end{itemize}
		\end{itemize}
	\end{column}
	\begin{column}{0.4\linewidth}
