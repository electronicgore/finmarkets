...
%	\end{itemize}
%	\begin{figure}
%		\includegraphics[width=.4\paperwidth]{pics/ch1/Image_PriceTaking2}
%	\end{figure}
...
%	\end{itemize}
%	\begin{figure}
%		\includegraphics[width=.4\paperwidth]{pics/ch1/Image_Strategic2}
%	\end{figure}
...
\begin{frame}{Conclusions}
	\begin{itemize}
		...
		\item \alert{Call auction} is \structure{welfare-maximizing} given the orders, is also \structure{Pareto-optimal} -- there are no profitable trades left to conduct after market closes
		\item \alert{Continuous auction} acts based on limited info (about future orders), results in \structure{too much trade and less welfare}.
		\begin{itemize}
