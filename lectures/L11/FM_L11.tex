...
\begin{frame}{Information}
	\begin{itemize}
		...
		\item Feedback between stock prices and firm decisions opens up scope for manipulation
		%; see \cite{goldstein_manipulation_2008}.
		%TODO: ^ uncomment if not an exam problem
	\end{itemize}
\end{frame}
