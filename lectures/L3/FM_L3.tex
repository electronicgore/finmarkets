...
\begin{frame}{Information and prices}
	...
	\begin{itemize}
		...
		\item \textbf{Strong form}: Prices reflect all public and private information (this is the kind of efficiency we had in mind in the previous lectures)
	\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\begin{equation*}
		...
		\right.
	\end{equation*}
	\item Speculator is risk-neutral, so his best response to $(a_t,b_t)$ is (assume $a_t \geq b_t$)
	\begin{itemize}
