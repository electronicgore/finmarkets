...
One of the news articles assigned earlier in the course argued that corporate bond markets are significantly less liquid than stock markets. This is partly due to a more opaque trading tradition: instead of the dealers posting their quotes openly, the bond markets operate via Requests For Quotes (RFQ). In particular, an interested trader must contact the dealer with an RFQ, and then the dealer would respond with a quote. This process is somewhat time-consuming. However, the costs of this opaqueness can be far greater than just these costs.
